...
@Injectable()
export class RepaymentHelperService {
    private readonly logger = new CustomLogger(RepaymentHelperService.name);
    ...
    async getLoanStatus(loan: Loan): Promise<string> {
        ...
        // if payment status is late if paid_date is greater then grace repayment date
