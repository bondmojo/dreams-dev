...
export class CreateDreamerUsecase {
    ...
    constructor(private readonly sendpulseService: SendpluseService, private readonly zohoservice: ZohoService) {}
    ...
    async create(createDreamerDto: CreateDreamerDto): Promise<DreamerModel> {
        ...
        dreamer.id = await this.zohoservice.createDreamer(dreamer);
        return dreamer;
    }
